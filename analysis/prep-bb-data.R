# Prepare data and spde object for BB case study (see case-study-bb.R)
# Modified version of this script: https://github.com/James-Thorson/Spatio-temporal-models-for-ecologists/blob/main/Chap_11/BBS.R
...
pop_dens <- st_read(file.path(data_dir, "BB/population_density.csv"),
...
sf_states <- sf_states[pmatch(c("Cal", "Oregon", "Washington", "Idaho", "Montana",
                                "Utah", "New Mex", "Arizona", "Wyoming", "Colorad", "Nevada"),
                              sf_states$name_en), ]
...
ggsave(paste0(here::here(), "/results/figures/supporting/bb_mesh.pdf"),
